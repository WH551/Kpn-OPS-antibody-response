...
fig.tight_layout()
plt.savefig(result_folder+"Spagetti_plot_HSA_EPA_raw_data.png", dpi=500, transparent=True, bbox_inches='tight')
...
fig.tight_layout()
plt.savefig(result_folder+"Spaghetti_plot_of_HSA_EPA_No_EPA-Positive_samples.png", dpi=500, transparent=True, bbox_inches='tight')
...
def plot_scatter(ax, condition_df, legend_title):
    ...
    ax.set_xlabel(antibody+" fold change to MrkA", fontsize=18)
    ax.set_ylabel(antibody+" fold change to homologous OPS", fontsize=18)
